...
<div class="header page-header detail-page-header"><div class="row">
    <div>
        <h3><div class="header-breadcrumbs fixed-header-breadcrumbs"><a href="#Dashboard" class="action">Dashboard</a><span class="subsection"><a href="#Catalog" class="action" data-action="navigateToRoot">Групи товарів</a></span><span>новий</span></div><div class="header-title">новий</div></h3>
    </div>
...
<div class="record"><div class="edit" id="catalog-edit-9399">
    <form method="POST" action="{{ route('grup.store')}}" enctype="multipart/form-data">
        @csrf
    <div class="detail-button-container button-container record-buttons clearfix">
        <div class="btn-group" role="group">
            <button  type="submit" class="btn btn-primary action" data-action="save" type="button">Зберегти</button>
            <button class="btn btn-default action" data-action="cancel" type="button"><a href="/grups">Скасувати</a></button>
        </div>
        ...
        <div class="panel-body panel-body-form">
            ...
            <div class="row">
                    ...
                    <div class="cell col-sm-6 form-group" data-name="nameEnUs">
                        <label class="control-label" data-name="nameEnUs"><span class="label-text">Назва / en_US</span><span class="required-sign"> *</span></label>
